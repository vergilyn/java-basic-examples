...
package com.vergilyn.examples.common.io.nacos;
 ...
 *
 * <p>
 * vergilyn-comment, 2021-03-29 >>>> <br/>
 *   1. read: {@linkplain RandomAccessFile} or {@linkplain CharArrayWriter}. <br/>
 *   2. write:
 *
 * @author nacos-2.0.0
 */
public class IoUtils {
    ...
    public static final String DEFAULT_ENCODE = StandardCharsets.UTF_8.toString();

    /**
     * Nacos `LocalConfigInfoProcessor#readFile()`
     */
    public static String readFile(File file, boolean isMultiInstance) throws IOException {
        ...
        if (isMultiInstance) {
            ...
            return ConcurrentDiskUtil.getFileContent(file, DEFAULT_ENCODE);
        } else {
            InputStream is = null;
            try {
                is = new FileInputStream(file);
                // java.io.CharArrayWriter
                return toString(is, DEFAULT_ENCODE);
            } finally {
                try {
                    if (null != is) {
                        is.close();
