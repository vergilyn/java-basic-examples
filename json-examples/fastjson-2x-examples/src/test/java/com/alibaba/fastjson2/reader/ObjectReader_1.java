 ...
 * </pre>
 */
public final class ObjectReader_1
		extends ObjectReaderAdapter {
	public FieldReader fr0;
	public ObjectReader objectReader_0;

	public ObjectReader_1(Class clazz, Supplier supplier, FieldReader[] fieldReaderArray) {
	...
	public Object readObject(JSONReader jSONReader, long l) {
		...
		while (!jSONReader.nextIfMatch('}') && (l2 = jSONReader.readFieldNameHashCode()) != -1L) {
			...
			if (l2 == 1565359023438024281L) {
				...
				if (l2 == 1565359023438024281L || l2 == -7735419762015468167L) {
					String string = jSONReader.readString();
					if (string != null) {
						// empty if block
					}
