 ...
 * 
 * <p>2020-04-08 >>>>
 *   不支持 内部类。原因{@linkplain #loadFile(Class, String, ClassLoader, Class[], Object[])} -> {@linkplain #initInstance(Class, Class, Class[], Object[])}
 *   中通过反射实例化{@linkplain Class#newInstance()}，并未支持 内部类。<br/>
 *
 *   也没必要支持内部类，因为主类一般都是接口，实现类也不需要强求要写成内部类。
 * </p>
 *META-INF
 * @author slievrly
 */
